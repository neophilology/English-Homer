"""
Odyssey Text Processing Library
===============================
...
def book_into_df(author, year, title, list_books):
    """
    Creates a DataFrame from a list of book texts with metadata.

    Args:
        author (str): Author name
        year (str): Publication year
        title (str): Book title
        list_books (list): List of text segments representing books/chapters
...
def count_lines(text):
    """
    Count the number of lines in a text by the number of newline characters.
...
def count_sentences(text):
    """
    Count the number of sentences in a text based on punctuation marks.
...
def count_words(text):
    """
    Count the number of words in a text using regex word boundary patterns.
...
####################################################################################################
# DataFrame Quality Checking
####################################################################################################


def check_df(df):
    """
    Check a DataFrame for missing values and display information about its structure.
...
class NLPPipeline:
    ...
    Attributes:
        ...
        stopwords (set): Base set of stopwords from NLTK
        custom_include_stopwords (set): User-defined stopwords to include
        custom_exclude_stopwords (set): User-defined stopwords to exclude
        effective_stopwords (set): Final set of stopwords after customization
        default_punctuation (set): Default punctuation characters to remove
        keep_punctuation (set): Punctuation characters to keep
        punctuation_to_remove (set): Additional characters to remove
        effective_punctuation (set): Final set of punctuation after customization
    """
